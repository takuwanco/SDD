...
- **書籍の練習**: 『仕様駆動開発 実践入門』を読みながら、7つの工程のサンプルファイルを手元で確認する
- **SDD導入の参考**: チームや組織に仕様駆動開発を導入する際の、リポジトリ構成テンプレートとして活用する
...
`spec-ai-writer/` ディレクトリには、仕様駆動開発を支援するオプションのAIツールが含まれています。LLM APIを使ってインタビュー形式で対話を行い、7つの工程の仕様書を自動生成します（Python 3.9以上・Node.js必要）。
