...
- **第3章**: Cursor関連動画一覧（`docs/cursor-videos.md`）への参照
- **第4章**: Gitコマンド一覧（`docs/git-commands.md`）への参照
- **第5章**: プロンプト集（`docs/prompts.md`）への参照、90日間導入プラン（`docs/90-day-introduction-plan.md`）への参照
- **第10章**: 各種ガイド（Markdown記法、Word/Excel変換、OASYS/一太郎変換など）への参照
- **第11章**: 90日間導入プラン（`docs/90-day-introduction-plan.md`）への参照
- **第12章**: スクリプト集（`docs/scripts.md`）への参照、90日間導入プラン（`docs/90-day-introduction-plan.md`）への参照
...
このリモートリポジトリは、本書の読者が練習のために使用することを目的としています。フォークして自由に編集・利用してください。
